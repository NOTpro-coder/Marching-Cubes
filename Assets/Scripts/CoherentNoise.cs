...
public class SimplexNoiseGenerator
{
    ...
    public float coherentNoise(Vector3 point, int octaves = 1, float multiplier = 10f, float amplitude = 0.5f, float lacunarity = 2, float persistence = 0.9f)
    {
        Vector3 v3 = point / multiplier;
        float val = 0;
